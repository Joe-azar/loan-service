...
class LoanEvaluationService(ServiceBase):
    ...
    def evaluate_loan(ctx, loan_request):
        ...
        solvency_score = solvency_client.service.check_solvency(extracted_info['Nom'], extracted_info['Revenu Mensuel'], extracted_info['Dépenses Mensuelles'])
        ...
        property_value = property_client.service.evaluate_property(extracted_info['Description de la Propriété'], extracted_info['Adresse'])
        ...
        decision = approval_client.service.make_decision(solvency_score, property_value, extracted_info['Montant du Prêt'])
